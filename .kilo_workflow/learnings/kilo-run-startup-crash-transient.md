...
succeeds immediately. It still counts toward the loop's round cap. When dispatching a fan-out of
agents at once, stagger the launches by a few seconds; the crash clusters when several CLIs
start together.
