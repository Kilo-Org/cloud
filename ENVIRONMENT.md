...
- `BYOC_VERCEL_IDS` - Comma-separated user or organization IDs enrolled in customer-paid Vercel compute. Empty is off; an enrolled owner fails closed when its ready credential is absent. [SERVER]
