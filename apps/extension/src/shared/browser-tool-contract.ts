/* eslint-disable max-lines, sort-keys, typescript-eslint/consistent-type-definitions, unicorn/numeric-separators-style -- Upstream tools/list output is vendored verbatim */
// Generated by node apps/extension/scripts/generate-browser-tool-contract.mjs. Do not edit by hand.
//
// Upstream: @playwright/mcp 0.0.81 (pin: @playwright/mcp@0.0.81)
// Generation command: node apps/extension/scripts/generate-browser-tool-contract.mjs
// Raw tools/list JSON SHA-256: 6ee94e2fca227ae0a6304c476e20731acf4650f1f5856c9cf7b734a368fcadda
//
...
export const UPSTREAM_PLAYWRIGHT_MCP_VERSION = '0.0.81';

export const BROWSER_TOOL_CONTRACT: readonly BrowserToolContractEntry[] = [
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        params: {
          description: 'Input parameters for the tool, matching its inputSchema',
          type: 'object',
          propertyNames: {
            type: 'string',
          },
        ...
        frame: {
          description:
            'Frame that registered the tool, as reported by browser_webmcp_list, when the same tool name exists in multiple frames',
          type: 'string',
        },
      },
      required: ['name'],
...
export const toKiloBrowserToolName = (name: string): string => `${KILO_BROWSER_TOOL_PREFIX}${name}`;
