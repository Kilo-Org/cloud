/* eslint-disable max-lines -- Cloud session create screen bundles closely related prompt/toolbar/repository concerns in a single component to keep navigation props colocated. */
