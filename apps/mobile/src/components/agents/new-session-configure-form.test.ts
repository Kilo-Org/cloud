...
// The loading profile row renders a Skeleton; the real one pulls in Reanimated,
// whose worklets package cannot load under this node project. The pending-
// environment case asserts the element by name, so the stub is the type it
// looks for.
