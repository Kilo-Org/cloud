...
// The profile row renders Skeleton, and that module imports
// react-native-reanimated: loading it in this node project dies inside
// react-native-worklets' ESM entry before any assertion runs. The row's
// shimmer is not what these cases check, so it renders as a host component.
