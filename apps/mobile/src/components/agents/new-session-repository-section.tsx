      ...
      >
        ...
        <View className="flex-row gap-2">
          ...
          >
            ...
            {/*
              The label owns the row's remaining width and is pinned to one
              line. A box sized to the label's own measured width is a fraction
              narrower than the glyphs Android lays out, so "Open GitLab"
              wrapped onto two lines and grew the button taller than its
              one-line siblings; giving the label the free space keeps its box
              wider than the text, and `numberOfLines` pins the line.
            */}
