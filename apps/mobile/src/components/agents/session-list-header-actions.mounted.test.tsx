...
describe('SessionListHeaderActions new-session control', () => {
  ...
  it('meets the filter control at the row gap instead of overlapping its touch region', async () => {
    ...
    // The filter control passes a numeric (symmetric) hitSlop while the
    // new-session control passes per-side insets; normalise the filter's to its
    // per-side reach before comparing the two facing slops.
