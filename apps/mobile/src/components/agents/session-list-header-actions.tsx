...
// 14pt, so `gap-4` (1rem) is 14pt. The filter control reaches 3pt past its own
// left edge, so capping the new-session control's right side at 6 keeps the two
// facing reaches (6 + 3 = 9pt) inside the gap while 32 + 8 + 6 = 46pt still
// clears `DESIGN.md:364`'s 44pt.
