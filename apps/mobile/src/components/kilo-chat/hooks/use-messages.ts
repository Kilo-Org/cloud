...
export function useAddReaction(conversationId: string | null, currentUserId: string) {
  const client = useKiloChatClient();
  const queryClient = useQueryClient();
  return useMutation({
...
export function useRemoveReaction(conversationId: string | null, currentUserId: string) {
  const client = useKiloChatClient();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({ messageId, emoji }: { messageId: string; emoji: string }) => {
...
export function useExecuteAction(conversationId: string | null, currentUserId: string) {
  const client = useKiloChatClient();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
