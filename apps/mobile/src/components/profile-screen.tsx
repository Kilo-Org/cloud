...
export function ProfileScreen() {
  ...
  // Sign-out confirms through the in-app dialog on both platforms: Android's
  // native alert paints every button with the theme accent and drops
  // `Alert.alert`'s destructive style, so the red affordance is lost there. The
  // dialog carries it on iOS and Android alike, so the confirmation is one
  // implementation with no per-platform branch.
