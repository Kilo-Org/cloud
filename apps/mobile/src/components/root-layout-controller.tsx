...
export function RootLayoutController() {
  ...
  /* eslint-disable react/style-prop-object -- expo-status-bar's `StatusBar` takes a string enum for `style`, not a style object */
  return (
    <ShareIntentProvider>
