        ...
        return (
          ...
          >
            {/* `numberOfLines` + `adjustsFontSizeToFit` keeps a longer label
                ...
                One line per option: a wrapped label made the equal-width
                segments render at unequal height and weight, and the platform
                shrinks the font to fit rather than truncating. Longer locales
                ellipsize instead of growing a second line; the radio's
                accessibilityLabel still carries the full text. */}
            <Text
              numberOfLines={1}
