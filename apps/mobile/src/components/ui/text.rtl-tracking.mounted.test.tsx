...
describe('Text tracked labels in RTL', () => {
  ...
  it('applies the same reset to the shared Eyebrow label', () => {
    ...
    // an RTL eyebrow drops them rather than keeping them like a caller-supplied
    // tracked class. The shared label carries no tracked class, so no
    // uppercase/tracked class is left for the shared reset to neutralize on
    // this label — the reset style is its whole treatment — and the zero
