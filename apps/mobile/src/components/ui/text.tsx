...
function Text({
  ...
  return (
    <Component
      // The Latin-only mono family cannot draw Arabic letters (see
      // `withoutMonoFamily`), so Arabic text drops it and keeps the system
      // font the rest of an RTL screen uses.
