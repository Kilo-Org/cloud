 ...
 * Agents history label, the profile-editor validation copy (the duplicate-key
 * refusal and the MCP bound messages), and the `/` suggestion list's skill-row
 * keys (`agentChat.slashCommands.skillBadge` and
