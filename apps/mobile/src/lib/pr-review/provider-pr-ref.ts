...
export function providerPrTermKey(
  ...
  // i18n-dup-ok: 'prReview.terms.mergeRequest'/'prReview.terms.pullRequest' are the capitalized standalone labels (chips, headers); the mid-sentence lowercase noun is 'common.mergeRequest'/'common.pullRequest' — languages case-decline them apart.
