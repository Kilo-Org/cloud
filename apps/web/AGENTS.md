...
1. Load and follow the `kilo-design` skill at `../../.agents/skills/kilo-design/SKILL.md`.
2. Prefer existing Kilo tokens, components, and utilities before adding new visual primitives.
