...
describe('/api/marketplace/plugins', () => {
  beforeEach(() => {
    fetchMock.mockReset();
  ...
  it('passes through generated plugins marketplace YAML', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://raw.githubusercontent.com/Kilo-Org/kilo-marketplace/main/plugins/marketplace.yaml'
    );
