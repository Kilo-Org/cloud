...
import { lowBalanceAlertRecipientCount, lowBalanceAlertStateLabel } from './spending-alerts-form';
...
export function OrganizationEmailPreferencesCard({ organizationId }: Props) {
  ...
  const spendingRecipientCount = lowBalanceAlertRecipientCount(settings);
  return (
    <Card>
      <CardHeader>
        <CardTitle>
      ...
      <CardContent>
        <div className="divide-border divide-y">
          <PreferenceRow
            ...
            stateLabel={lowBalanceAlertStateLabel(spendingRecipientCount)}
