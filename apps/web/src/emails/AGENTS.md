...
| `securityFindingNew.html` | `severity`, `repository_name`, `finding_title`, `action_url`, `year` | — |
| `securityFindingSlaWarning.html` | `severity`, `repository_name`, `finding_title`, `sla_deadline`, `action_url`, `year` | — |
| `securityFindingSlaBreach.html` | `severity`, `repository_name`, `finding_title`, `sla_deadline`, `action_url`, `year` | — |
