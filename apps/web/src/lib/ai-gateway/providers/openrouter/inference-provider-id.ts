...
export const UserByokTestModels = {
  ...
  [VercelUserByokInferenceProviderIdSchema.enum.bedrock]: 'openai/gpt-oss-20b',
  [VercelUserByokInferenceProviderIdSchema.enum.deepseek]: 'deepseek/deepseek-v4-flash',
  ...
  [VercelUserByokInferenceProviderIdSchema.enum.minimax]: 'minimax/minimax-m2.7',
  ...
  [VercelUserByokInferenceProviderIdSchema.enum.zai]: 'zai/glm-4.7-flashx',
