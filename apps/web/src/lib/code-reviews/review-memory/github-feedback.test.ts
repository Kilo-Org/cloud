...
import { handleGitHubReviewCommentReply, type FetchParentReviewComment } from './github-feedback';
...
function parentFetcher(input: { userLogin: string | null }): FetchParentReviewComment {
  return async request => ({
    id: request.commentId,
    body: 'Kilo review comment',
