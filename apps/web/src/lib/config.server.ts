...
export const BITBUCKET_CODE_REVIEW_WEBHOOK_SIGNING_KEYS = getEnvVariable(
  'BITBUCKET_CODE_REVIEW_WEBHOOK_SIGNING_KEYS'
);
export const BITBUCKET_CODE_REVIEW_WEBHOOK_BASE_URL =
...
// Native mobile sign-in (comma-separable Apple bundle IDs; native Google client is
// a separate OAuth client from the web GOOGLE_CLIENT_ID)
export const APPLE_NATIVE_CLIENT_IDS = getEnvVariable('APPLE_NATIVE_CLIENT_IDS');
