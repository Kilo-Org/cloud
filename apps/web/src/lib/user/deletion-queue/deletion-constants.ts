...
export const USER_DELETION_ID_ONLY_CATALOG_VERSION = 3;
...
export const USER_DELETION_ANONYMIZE_PAGE_TIMEOUT_MS = 8_000;
...
export const USER_DELETION_COMPLETION_HTML =
