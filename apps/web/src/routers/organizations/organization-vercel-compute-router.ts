...
const VercelComputeStatusOutput = z.object({
  ...
  runtimeWrapperVersion: z.string().nullable(),
  runtimeReleasedAt: z.string().nullable(),
  runtimeDigest: z.string().nullable(),
  upgradeStatus: VercelComputeUpgradeStatusSchema.nullable(),
  upgradeStep: z.string().nullable(),
  upgradeError: z.string().nullable(),
  latestWrapperVersion: z.string().nullable(),
  latestReleasedAt: z.string().nullable(),
