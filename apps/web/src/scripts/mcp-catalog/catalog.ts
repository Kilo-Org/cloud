 ...
 * as well, and this filter applies on top of the mutation allowlist.
 * Subscriptions are never exported, individual procedures cannot opt back in,
 * and `admin` and `test` stay internal-only; `debug` is published, marked with
