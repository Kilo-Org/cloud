    ...
    it('provisions workspace, clones repo, and creates session branch directly', async () => {
      ...
      expect(sandboxCreateSession).toHaveBeenCalledWith({
        ...
        env: {
          ...
          OPENCODE_CONFIG_CONTENT: `{"permission":{"external_directory":{"/tmp/${sessionId}/**":"allow","/workspace/org/user/sessions/${sessionId}/**":"allow"}},"provider":{"kilo":{"options":{"apiKey":"token","kilocodeToken":"token","kilocodeOrganizationId":"org"}}},"model":"kilo/test-model"}`,
          KILO_CONFIG_CONTENT: `{"permission":{"external_directory":{"/tmp/${sessionId}/**":"allow","/workspace/org/user/sessions/${sessionId}/**":"allow"}},"provider":{"kilo":{"options":{"apiKey":"token","kilocodeToken":"token","kilocodeOrganizationId":"org"}}},"model":"kilo/test-model"}`,
        },
