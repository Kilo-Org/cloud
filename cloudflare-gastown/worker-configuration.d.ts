/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f883343f7ce6e58556c218422668647a)
// Runtime types generated with workerd@1.20260128.0 2026-01-27 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'RigDO' | 'TownDO' | 'AgentIdentityDO';
  }
  interface Env {
    RIG: DurableObjectNamespace<import('./src/index').RigDO>;
    TOWN: DurableObjectNamespace<import('./src/index').TownDO>;
    AGENT_IDENTITY: DurableObjectNamespace<import('./src/index').AgentIdentityDO>;
  }
}
