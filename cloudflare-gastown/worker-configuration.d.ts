/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8eddca3b66d4fc6f9bc96b50e4698a10)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'ENVIRONMENT' | 'CF_ACCESS_TEAM' | 'CF_ACCESS_AUD' | 'KILO_API_URL' | 'GASTOWN_API_URL'
      >
    > {}
}
