/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 06b324f5a6851b38674c08ce4cfc19fd)
...
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: 'RigDO' | 'TownDO' | 'AgentIdentityDO' | 'TownContainerDO';
  }
  interface DevEnv {
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, 'ENVIRONMENT' | 'CF_ACCESS_TEAM' | 'CF_ACCESS_AUD'>
    > {}
}
