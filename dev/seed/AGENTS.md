...
- Reset only their own data at start for idempotent reruns. Ad-hoc topics delete by stable ids/emails, stable sandbox prefixes, or `dev-seed:` category prefixes.
