CREATE TABLE "api_format" (
	"api_format_id" serial PRIMARY KEY NOT NULL,
	"api_format" text NOT NULL
);
--> statement-breakpoint
DROP VIEW "public"."microdollar_usage_view";--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "api_format_id" integer;--> statement-breakpoint
CREATE UNIQUE INDEX "UQ_api_format" ON "api_format" USING btree ("api_format");--> statement-breakpoint
