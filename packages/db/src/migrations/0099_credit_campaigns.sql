CREATE TABLE "credit_campaigns" (
	...
	CONSTRAINT "credit_campaigns_total_redemptions_allowed_positive_check" CHECK ("credit_campaigns"."total_redemptions_allowed" IS NULL OR "credit_campaigns"."total_redemptions_allowed" > 0)
);
