...
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "user_byok_key_id" uuid;--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD CONSTRAINT "microdollar_usage_metadata_user_byok_key_id_byok_api_keys_id_fk" FOREIGN KEY ("user_byok_key_id") REFERENCES "public"."byok_api_keys"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
