...
CREATE INDEX "IDX_mcp_gateway_audit_events_grant" ON "mcp_gateway_audit_events" USING btree ("oauth_grant_id");--> statement-breakpoint
CREATE INDEX "IDX_mcp_gateway_authorization_codes_grant" ON "mcp_gateway_authorization_codes" USING btree ("oauth_grant_id");--> statement-breakpoint
CREATE INDEX "IDX_mcp_gateway_authorization_requests_grant" ON "mcp_gateway_authorization_requests" USING btree ("oauth_grant_id");--> statement-breakpoint
CREATE INDEX "IDX_mcp_gateway_pending_provider_authorizations_grant" ON "mcp_gateway_pending_provider_authorizations" USING btree ("oauth_grant_id");--> statement-breakpoint
CREATE INDEX "IDX_mcp_gateway_refresh_tokens_grant" ON "mcp_gateway_refresh_tokens" USING btree ("oauth_grant_id");