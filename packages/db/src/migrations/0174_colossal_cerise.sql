...
CREATE INDEX CONCURRENTLY "IDX_mcp_gateway_audit_events_grant" ON "mcp_gateway_audit_events" USING btree ("oauth_grant_id") WHERE "mcp_gateway_audit_events"."oauth_grant_id" is not null;--> statement-breakpoint
CREATE INDEX CONCURRENTLY "IDX_mcp_gateway_authorization_codes_grant" ON "mcp_gateway_authorization_codes" USING btree ("oauth_grant_id") WHERE "mcp_gateway_authorization_codes"."oauth_grant_id" is not null;--> statement-breakpoint
CREATE INDEX CONCURRENTLY "IDX_mcp_gateway_authorization_requests_grant" ON "mcp_gateway_authorization_requests" USING btree ("oauth_grant_id") WHERE "mcp_gateway_authorization_requests"."oauth_grant_id" is not null;--> statement-breakpoint
CREATE INDEX CONCURRENTLY "IDX_mcp_gateway_pending_provider_authorizations_grant" ON "mcp_gateway_pending_provider_authorizations" USING btree ("oauth_grant_id") WHERE "mcp_gateway_pending_provider_authorizations"."oauth_grant_id" is not null;--> statement-breakpoint
CREATE INDEX CONCURRENTLY "IDX_mcp_gateway_refresh_tokens_grant" ON "mcp_gateway_refresh_tokens" USING btree ("oauth_grant_id") WHERE "mcp_gateway_refresh_tokens"."oauth_grant_id" is not null;