...
CREATE INDEX "IDX_cloud_agent_session_runs_responsibility_reason_terminal" ON "cloud_agent_session_runs" USING btree ("failure_responsibility","failure_reason","terminal_at") WHERE "cloud_agent_session_runs"."status" = 'failed';