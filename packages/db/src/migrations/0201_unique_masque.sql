...
CREATE UNIQUE INDEX "UQ_kilo_pass_org_agreements_provider_subscription" ON "kilo_pass_org_agreements" USING btree ("provider_subscription_id") WHERE "kilo_pass_org_agreements"."provider_subscription_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "UQ_kilo_pass_org_agreements_provider_seat_add_on_item" ON "kilo_pass_org_agreements" USING btree ("provider_seat_add_on_item_id") WHERE "kilo_pass_org_agreements"."provider_seat_add_on_item_id" IS NOT NULL;--> statement-breakpoint
