...
CREATE INDEX "IDX_kilo_pass_org_allocation_plan_rows_positive_container" ON "kilo_pass_org_allocation_plan_rows" USING btree ("allocation_container_organization_id") WHERE "kilo_pass_org_allocation_plan_rows"."pass_capacity" > 0;--> statement-breakpoint
