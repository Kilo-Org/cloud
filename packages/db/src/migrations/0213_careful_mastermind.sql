CREATE TABLE "organization_service_fee_exemption_history" (
	...
	CONSTRAINT "organization_service_fee_exemption_history_reason_check" CHECK (length(trim("organization_service_fee_exemption_history"."reason")) > 0)
);
...
CREATE TABLE "stripe_service_fee_assessments" (
	...
	CONSTRAINT "stripe_service_fee_assessments_assessment_key_unique" UNIQUE("assessment_key"),
	...
	CONSTRAINT "stripe_service_fee_assessments_eligibility_check" CHECK ("stripe_service_fee_assessments"."eligibility" IN ('eligible', 'exempt', 'pre_activation')),
	...
	CONSTRAINT "stripe_service_fee_assessments_exemption_history_check" CHECK (("stripe_service_fee_assessments"."eligibility" = 'exempt') = ("stripe_service_fee_assessments"."exemption_history_id" IS NOT NULL))
);
--> statement-breakpoint
ALTER TABLE "organization_service_fee_exemption_history" ADD CONSTRAINT "FK_org_svc_fee_exemption_history_organization" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "organization_service_fee_exemption_history" ADD CONSTRAINT "FK_org_svc_fee_exemption_history_changed_by" FOREIGN KEY ("changed_by_kilo_user_id") REFERENCES "public"."kilocode_users"("id") ON DELETE set null ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "organization_service_fee_exemptions" ADD CONSTRAINT "FK_org_svc_fee_exemptions_current_history" FOREIGN KEY ("current_history_id") REFERENCES "public"."organization_service_fee_exemption_history"("id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "stripe_service_fee_assessments" ADD CONSTRAINT "FK_stripe_svc_fee_assessments_exemption_history" FOREIGN KEY ("exemption_history_id") REFERENCES "public"."organization_service_fee_exemption_history"("id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
CREATE INDEX "IDX_org_service_fee_exemption_history_org_created_at" ON "organization_service_fee_exemption_history" USING btree ("organization_id","created_at" DESC NULLS LAST);--> statement-breakpoint
