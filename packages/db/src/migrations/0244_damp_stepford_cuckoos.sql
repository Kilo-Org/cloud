...
CREATE TABLE "provider_installation_reservations" (
	...
	CONSTRAINT "provider_installation_reservations_status_check" CHECK ("provider_installation_reservations"."status" IN ('pending', 'active')),
...
-->  statement-breakpoint
INSERT INTO "provider_installation_reservations" (
	"provider",
