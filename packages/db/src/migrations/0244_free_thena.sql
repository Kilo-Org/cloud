...
ALTER TABLE "platform_integrations" ADD CONSTRAINT "platform_integrations_github_installation_id_github_app_installations_id_fk" FOREIGN KEY ("github_installation_id") REFERENCES "public"."github_app_installations"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
