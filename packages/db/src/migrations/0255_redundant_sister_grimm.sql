CREATE TABLE "organization_alert_deliveries" (
	...
	"measured_value_microdollars" bigint NOT NULL,
	...
	CONSTRAINT "organization_alert_deliveries_measured_value_check" CHECK ("organization_alert_deliveries"."threshold_microdollars" > 0 AND "organization_alert_deliveries"."measured_value_microdollars" >= 0),
...
CREATE TABLE "organization_alerts" (
	...
	CONSTRAINT "organization_alerts_type_check" CHECK ("organization_alerts"."type" IN ('monthly_spending', 'low_balance')),
