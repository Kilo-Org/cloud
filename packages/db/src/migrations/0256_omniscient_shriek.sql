CREATE TABLE "organization_vercel_compute_credentials" (
	...
	CONSTRAINT "organization_vercel_compute_credentials_upgrade_status_check" CHECK ("organization_vercel_compute_credentials"."upgrade_status" IS NULL OR "organization_vercel_compute_credentials"."upgrade_status" IN ('pending', 'building', 'failed'))
);
