ALTER TABLE "openai_chatgpt_connections" DROP CONSTRAINT "openai_chatgpt_connections_kilo_user_id_kilocode_users_id_fk";
--> statement-breakpoint
DROP INDEX "UQ_openai_chatgpt_connections_org_member";--> statement-breakpoint
ALTER TABLE "openai_chatgpt_connections" ALTER COLUMN "kilo_user_id" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "openai_chatgpt_connections" ADD CONSTRAINT "openai_chatgpt_connections_kilo_user_id_kilocode_users_id_fk" FOREIGN KEY ("kilo_user_id") REFERENCES "public"."kilocode_users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
