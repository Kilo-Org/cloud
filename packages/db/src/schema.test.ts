...
describe('database schema', () => {
  ...
  it('should have stable enum values for schema check constraints (run pnpm drizzle generate if you changed an enum)', () => {
    ...
    const expectedEnumValues = {
      ...
      KiloPassOrgAgreementState: ['pending_payment', 'active', 'cancel_at_period_end', 'ended'],
      ...
      KiloPassOrgPurchaseChannel: ['self_serve', 'manual'],
      KiloPassOrgProcessingRunState: ['pending', 'running', 'succeeded', 'blocked', 'failed'],
      KiloPassOrgBonusMode: ['after_base', 'upfront'],
      KiloPassOrgIssuanceKind: ['regular', 'bridge', 'supplement'],
