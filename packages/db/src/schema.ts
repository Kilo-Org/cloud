...
export const StripeServiceFeeEligibility = {
  Eligible: 'eligible',
  Exempt: 'exempt',
  PreActivation: 'pre_activation',
} as const;

export type StripeServiceFeeEligibility =
  (typeof StripeServiceFeeEligibility)[keyof typeof StripeServiceFeeEligibility];
