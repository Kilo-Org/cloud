  ...
  private buildExecutionPlan(params: {
    ...
    const existingMetadataView = params.existingMetadata
      ? {
          ...
          mcpServers: existingMetadataProfile?.mcpServers,
          runtimeSkills: existingMetadataProfile?.runtimeSkills,
          runtimeAgents: existingMetadataProfile?.runtimeAgents,
    ...
    try {
      ...
      if (request.kind === 'initiate') {
        ...
        const initContext: InitializeContext = {
          ...
          setupCommands: request.setupCommands,
          mcpServers: request.mcpServers,
          runtimeSkills: request.runtimeSkills,
          runtimeAgents: request.runtimeAgents,
          upstreamBranch: request.upstreamBranch,
          botId: request.botId,
      ...
      if (request.kind === 'initiatePrepared') {
        ...
        const initContext: InitializeContext = {
          ...
          gitToken,
          envVars: metadataProfile.envVars,
          encryptedSecrets: metadataProfile.encryptedSecrets,
          setupCommands: metadataProfile.setupCommands,
          mcpServers: metadataProfile.mcpServers,
          runtimeSkills: metadataProfile.runtimeSkills,
