...
export function createPendingSessionMessageFromIntent(
  ...
  return createPendingSessionMessage({
    ...
    role: 'user',
    content: intent.turn.prompt,
    images: intent.turn.images,
    createdAt,
    executionOptions: {
      ...
      githubTokenOverride: intent.repositoryAuthOverrides?.githubToken,
      gitTokenOverride: intent.repositoryAuthOverrides?.gitToken,
    },
  });
}
...
export function resolvePendingSessionMessageIntent(
  ...
  const finalization =
    executionOptions.autoCommit !== undefined || executionOptions.condenseOnComplete !== undefined
      ...
      : undefined;
  const repositoryAuthOverrides =
    executionOptions.githubTokenOverride !== undefined ||
    executionOptions.gitTokenOverride !== undefined
      ? {
          githubToken: executionOptions.githubTokenOverride,
          gitToken: executionOptions.gitTokenOverride,
        }
      : undefined;
