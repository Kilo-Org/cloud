...
import { buildCloudAgentRules } from './cloud-agent-rules.js';

describe('buildCloudAgentRules', () => {
  it('renders bounded command guidance and session-specific scratch space', () => {
    expect(buildCloudAgentRules('agent_test')).toBe(`# Cloud Agent Environment
...
When you need to create temporary or scratch files, use \`/tmp/agent_test/\` as your scratch directory.
