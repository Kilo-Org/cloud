...
describe('sendKiloSnapshot → sendKiloState', () => {
  ...
  it('rejects pending questions for code-review snapshots without replaying them', async () => {
    const pendingQuestion = {
      id: 'q_123',
      sessionID: 'kilo_sess_456',
      tool: { messageID: 'msg_1', callID: 'call_1' },
  ...
  it('rejects pending permissions for code-review snapshots without replaying them', async () => {
