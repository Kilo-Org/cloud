/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c1e15211e6da081cb07d538a1d7e1548)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_SLUG" | "GITHUB_APP_BOT_USER_ID" | "GITHUB_LITE_APP_SLUG" | "GITHUB_LITE_APP_BOT_USER_ID" | "SANDBOX_TRANSPORT" | "CLI_TIMEOUT_SECONDS" | "REAPER_INTERVAL_MS" | "R2_ATTACHMENTS_BUCKET" | "BACKUP_BUCKET_NAME" | "CLOUDFLARE_R2_ACCOUNT_ID" | "PER_SESSION_SANDBOX_ORG_IDS" | "CREDENTIAL_CONTAINMENT_ENABLED" | "REPO_SNAPSHOT_ORG_IDS" | "CONTAINER_BILLING_HEARTBEAT_SECONDS" | "CONTROL_PLANE_IDS" | "WORKTREE_CREATION_ENABLED_IDS" | "VERCEL_SANDBOX_ORG_IDS" | "VERCEL_PROJECT_ID" | "VERCEL_TEAM_ID" | "VERCEL_SANDBOX_SNAPSHOT_ID" | "VERCEL_SANDBOX_RUNTIME_BUILD_ID" | "VERCEL_SANDBOX_RUNTIME" | "VERCEL_SANDBOX_INITIAL_TIMEOUT_MS" | "VERCEL_SANDBOX_EXTEND_DURATION_MS" | "NEXTAUTH_SECRET" | "INTERNAL_API_SECRET" | "KILOCODE_BACKEND_BASE_URL" | "KILO_OPENROUTER_BASE" | "WORKER_URL" | "AGENT_ENV_VARS_PRIVATE_KEY" | "R2_ENDPOINT" | "R2_ATTACHMENTS_READONLY_ACCESS_KEY_ID" | "R2_ATTACHMENTS_READONLY_SECRET_ACCESS_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "KILO_SESSION_INGEST_URL" | "LOG_REJECTED_KILO_URLS" | "WS_ALLOWED_ORIGINS" | "BYOC_VERCEL_ORG_IDS" | "TOOL_CGROUP_RESERVE_MB" | "TOOL_CGROUP_CPU_WEIGHT" | "CLOUD_AGENT_CONTAINER_BILLING_ENABLED" | "CLOUD_AGENT_CONTAINER_BILLING_USER_IDS" | "CLOUD_AGENT_CONTAINER_BILLING_ORG_IDS">> {}
}
declare module "*.sql" {
	const value: string;
