/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16dea3343c1ef5c8fd8ef2c36e221307)
// Runtime types generated with workerd@1.20260714.1 2026-06-03 nodejs_compat
interface __BaseEnv_Env {
	...
	BACKUP_BUCKET_NAME: "kilocode-sessions-dev" | "kilocode-sessions";
	CLOUDFLARE_R2_ACCOUNT_ID: "e115e769bcdd4c3d66af59d3332cb394";
	CREDENTIAL_CONTAINMENT_ENABLED: "false" | "true";
	REPO_SNAPSHOT_ORG_IDS?: "";
	CONTAINER_BILLING_HEARTBEAT_SECONDS: "60" | "300";
	...
	SandboxCodeReview: DurableObjectNamespace<import("./src/index").SandboxCodeReview>;
	SandboxContainment: DurableObjectNamespace<import("./src/index").SandboxContainment>;
	...
	CONTAINER_USAGE_METER: Service /* entrypoint ContainerUsageMeter from container-usage-meter */;
	TOOL_CGROUP_RESERVE_MB?: "2048";
	TOOL_CGROUP_CPU_WEIGHT?: "50";
	CLOUD_AGENT_CONTAINER_BILLING_ENABLED?: "true";
	CLOUD_AGENT_CONTAINER_BILLING_USER_IDS?: "f1a848ca-bade-48d8-a5ad-1042d08651e6";
	CLOUD_AGENT_CONTAINER_BILLING_ORG_IDS?: "9d278969-5453-4ae3-a51f-a8d2274a7b56";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "CloudAgentSession" | "SandboxSmall" | "SandboxDIND" | "UserKiloFacade" | "SandboxCodeReview" | "SandboxContainment" | "SandboxSmallContainment" | "SandboxCodeReviewContainment" | "StreamTicketNonceDO" | "SandboxControl" | "SandboxSession" | "VercelSnapshotBuild";
	}
	interface DevEnv {
		SHARED_SANDBOX_OVERRIDES: KVNamespace;
		R2_BUCKET: R2Bucket;
		...
		BACKUP_BUCKET_NAME: "kilocode-sessions-dev";
		CLOUDFLARE_R2_ACCOUNT_ID: "e115e769bcdd4c3d66af59d3332cb394";
		CREDENTIAL_CONTAINMENT_ENABLED: "false";
		REPO_SNAPSHOT_ORG_IDS: "";
		CONTAINER_BILLING_HEARTBEAT_SECONDS: "60";
		VERCEL_SANDBOX_INITIAL_TIMEOUT_MS: "300000";
		VERCEL_SANDBOX_EXTEND_DURATION_MS: "600000";
		NEXTAUTH_SECRET: string;
		KILO_SESSION_INGEST_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_LITE_APP_SLUG" | "GITHUB_LITE_APP_BOT_USER_ID" | "SANDBOX_TRANSPORT" | "R2_ATTACHMENTS_BUCKET" | "BACKUP_BUCKET_NAME" | "CLOUDFLARE_R2_ACCOUNT_ID" | "CREDENTIAL_CONTAINMENT_ENABLED" | "REPO_SNAPSHOT_ORG_IDS" | "CONTAINER_BILLING_HEARTBEAT_SECONDS" | "VERCEL_SANDBOX_INITIAL_TIMEOUT_MS" | "VERCEL_SANDBOX_EXTEND_DURATION_MS" | "NEXTAUTH_SECRET" | "KILO_SESSION_INGEST_URL" | "WORKER_URL" | "WS_ALLOWED_ORIGINS" | "KILOCODE_BACKEND_BASE_URL" | "KILO_OPENROUTER_BASE" | "INTERNAL_API_SECRET" | "R2_ENDPOINT" | "R2_ATTACHMENTS_READONLY_ACCESS_KEY_ID" | "R2_ATTACHMENTS_READONLY_SECRET_ACCESS_KEY" | "AGENT_ENV_VARS_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "CLI_TIMEOUT_SECONDS" | "REAPER_INTERVAL_MS" | "STALE_THRESHOLD_MS" | "PENDING_START_TIMEOUT_MS" | "GITHUB_APP_SLUG" | "GITHUB_APP_BOT_USER_ID" | "GITHUB_LITE_APP_ID" | "GITHUB_LITE_APP_PRIVATE_KEY" | "KILOCODE_SANDBOX_BACKEND_BASE_URL" | "VERCEL_TOKEN" | "VERCEL_TEAM_ID" | "VERCEL_PROJECT_ID" | "VERCEL_SANDBOX_SNAPSHOT_ID" | "VERCEL_SANDBOX_RUNTIME_BUILD_ID" | "VERCEL_SANDBOX_RUNTIME" | "CONTROL_PLANE_IDS" | "WORKTREE_CREATION_ENABLED_IDS" | "PER_SESSION_SANDBOX_ORG_IDS" | "VERCEL_SANDBOX_ORG_IDS" | "KILOCODE_TOKEN_CONTAINMENT_ORG_IDS" | "GITHUB_TOKEN_CONTAINMENT_ORG_IDS" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "LOG_REJECTED_KILO_URLS" | "BYOC_VERCEL_ORG_IDS" | "TOOL_CGROUP_RESERVE_MB" | "TOOL_CGROUP_CPU_WEIGHT" | "CLOUD_AGENT_CONTAINER_BILLING_ENABLED" | "CLOUD_AGENT_CONTAINER_BILLING_USER_IDS" | "CLOUD_AGENT_CONTAINER_BILLING_ORG_IDS">> {}
}
declare module "*.sql" {
	const value: string;
