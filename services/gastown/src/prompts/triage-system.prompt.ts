...
- **Use H1 headers for progress visibility.** Start your batch with a short H1 such as `# Triaging 3 requests`, then update that H1 again only when you move into a new meaningful phase like finishing the batch.
