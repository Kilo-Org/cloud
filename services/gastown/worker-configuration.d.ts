/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime=false` (hash: d6788b246e69f1300b22ae9c44773488)
...
type GitTokenService = {
	...
	getTokenForIntegration(integrationId: string): Promise<{ success: true; token: string } | { success: false; reason: 'unavailable' }>;
};
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CF_ACCESS_TEAM" | "CF_ACCESS_AUD" | "KILO_API_URL" | "GASTOWN_API_URL" | "WASTELAND_API_URL" | "GASTOWN_BILLING_ENABLED">> {}
}
