/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv worker-configuration.d.ts` (hash: 845f65551893477d27bd8781d3b8d187)
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		SCM_SESSION_CAPABILITY_ENCRYPTION_KEY: string;
	}
	interface Env {
		TOKEN_CACHE: KVNamespace;
		HYPERDRIVE: Hyperdrive;
		NEXTAUTH_SECRET: SecretsStoreSecret | string;
		SCM_SESSION_CAPABILITY_ENCRYPTION_KEY: SecretsStoreSecret | string;
