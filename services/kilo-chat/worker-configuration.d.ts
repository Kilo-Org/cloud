/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: de186ccc530ef43a6168adb8afc20fac)
// Runtime types generated with workerd@1.20260312.1 2026-02-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConversationDO" | "MembershipDO";
	}
	interface Env {
		WEBHOOK_QUEUE: Queue;
		KILOCHAT_WEBHOOK_URL: SecretsStoreSecret;
		KILOCHAT_WEBHOOK_SECRET: SecretsStoreSecret;
		KILOCHAT_API_TOKEN: SecretsStoreSecret;
