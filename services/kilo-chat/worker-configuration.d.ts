/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 036545a0a7c6fba5edb0a455dd0dafe3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_TOKEN_SECRET" | "NEXTAUTH_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
