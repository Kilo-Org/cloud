/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 92b3a7808ca3d786fe11eb9e1c9e4893)
// Runtime types generated with workerd@1.20260828.1 2025-09-01 nodejs_compat
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "KiloMcpOAuthStore";
	}
	interface DevEnv {
		VECTORIZE: VectorizeIndex;
		AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_BASE_URL" | "MCP_TOKEN_SECRET">> {}
}
