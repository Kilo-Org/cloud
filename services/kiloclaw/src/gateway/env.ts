...
export async function buildEnvVars(
  ...
  if (env.KILOCHAT_ENABLED) plainEnv.KILOCHAT_ENABLED = env.KILOCHAT_ENABLED;
  if (env.KILOCHAT_REACTION_LEVEL) plainEnv.KILOCHAT_REACTION_LEVEL = env.KILOCHAT_REACTION_LEVEL;
