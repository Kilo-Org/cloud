/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 693c6cb699d4f8880b88f93974e31524)
	...
	interface Env {
		...
		KILOCHAT: Fetcher & {
			...
			botSendTyping(params: {
				...
				| { ok: true }
				| { ok: false; code: "forbidden" | "invalid_sandbox"; error: string }
			>;
		};
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KILOCLAW_CHECKIN_URL" | "REQUIRE_PROXY_TOKEN" | "PROACTIVE_REFRESH_THRESHOLD_HOURS" | "NEXTAUTH_SECRET" | "INTERNAL_API_SECRET" | "GATEWAY_TOKEN_SECRET" | "WORKER_ENV" | "BACKEND_API_URL" | "FLY_API_TOKEN" | "FLY_ORG_SLUG" | "FLY_REGISTRY_APP" | "FLY_REGION" | "FLY_IMAGE_TAG" | "OPENCLAW_VERSION" | "FLY_APP_NAME" | "OPENCLAW_ALLOWED_ORIGINS" | "NEXT_PUBLIC_POSTHOG_KEY" | "STREAM_CHAT_API_KEY" | "STREAM_CHAT_API_SECRET" | "KILOCLAW_DEFAULT_PROVIDER" | "DOCKER_LOCAL_API_BASE" | "DOCKER_LOCAL_IMAGE" | "DOCKER_LOCAL_PORT_RANGE" | "KILOCHAT_API_TOKEN" | "KILOCHAT_BASE_URL" | "KILOCHAT_REACTION_LEVEL">> {}
}
