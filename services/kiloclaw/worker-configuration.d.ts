/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8b3b62eeab77a3af97c15ad0753d528)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NF_TEAM_ID" | "NF_REGION" | "NF_DEPLOYMENT_PLAN" | "NF_EDGE_HEADER_NAME" | "NF_IMAGE_PATH_TEMPLATE" | "NF_IMAGE_CREDENTIALS_ID" | "REQUIRE_PROXY_TOKEN" | "PROACTIVE_REFRESH_THRESHOLD_HOURS" | "NEXTAUTH_SECRET" | "INTERNAL_API_SECRET" | "GATEWAY_TOKEN_SECRET" | "WORKER_ENV" | "BACKEND_API_URL" | "FLY_API_TOKEN" | "FLY_ORG_SLUG" | "FLY_REGISTRY_APP" | "FLY_REGION" | "FLY_IMAGE_TAG" | "OPENCLAW_VERSION" | "FLY_APP_NAME" | "OPENCLAW_ALLOWED_ORIGINS" | "NEXT_PUBLIC_POSTHOG_KEY" | "KILOCHAT_API_TOKEN" | "KILOCHAT_WEBHOOK_SECRET" | "KILOCHAT_BASE_URL" | "KILOCLAW_DEFAULT_PROVIDER" | "KILOCLAW_CHECKIN_URL" | "KILOCODE_API_BASE_URL" | "FLY_IMAGE_DIGEST" | "FLY_IMAGE_CONTENT_HASH" | "KILOCLAW_INTERNAL_API_SECRET" | "DOCKER_LOCAL_API_BASE" | "DOCKER_LOCAL_IMAGE" | "DOCKER_LOCAL_PORT_RANGE" | "DEV_CREATOR" | "GOOGLE_WORKSPACE_OAUTH_REDIRECT_URI">> {}
}
