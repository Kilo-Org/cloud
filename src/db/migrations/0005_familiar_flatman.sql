CREATE TABLE "machine_id" (
	"machine_id_id" serial PRIMARY KEY NOT NULL,
	"machine_id" text NOT NULL
);
--> statement-breakpoint
DROP VIEW "public"."microdollar_usage_view";--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "machine_id_id" integer;--> statement-breakpoint
CREATE UNIQUE INDEX "UQ_machine_id" ON "machine_id" USING btree ("machine_id");--> statement-breakpoint
