...
export function isNvidiaModel(requestedModelId: string) {
  return requestedModelId.startsWith('nvidia/');
}

export function applyNvidiaModelSettings(requestToMutate: OpenRouterChatCompletionRequest) {
