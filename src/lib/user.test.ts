...
describe('User', () => {
  ...
  describe('softDeleteUser', () => {
    it('should anonymize the user row and preserve it', async () => {
      ...
      expect(softDeleted!.openrouter_upstream_safety_identifier).toBe('openrouter_upstream_safety_identifier');
      expect(softDeleted!.vercel_downstream_safety_identifier).toBe('vercel_downstream_safety_identifier');
